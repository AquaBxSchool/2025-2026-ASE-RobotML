...
/**
 * This is the item provider adapter for a {@link robotML.Foreach} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForeachItemProvider extends LoopItemProvider {
	/**
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Foreach_expression_feature",
								"_UI_Foreach_type"),
						RobotMLPackage.Literals.FOREACH__EXPRESSION, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RobotMLPackage.Literals.FOREACH__VARIABLE);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Foreach_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RobotMLPackage.Literals.FOREACH__VARIABLE,
