...
- [src/robot-ml.langium](src/robot-ml.langium) -  The grammar definition of your language
- [src/robot-ml-module.ts](src/robot-ml-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/robot-ml-validator.ts](src/robot-ml-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/robot-ml.monarch.ts](src/syntaxes/robot-ml.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/robot-ml.tmLanguage.json](syntaxes/robot-ml.tmLanguage.json) - Textmate based syntax highlighting instructions.
