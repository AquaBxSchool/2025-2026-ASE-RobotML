import { ArgumentDec, Assignation, Backward, Block, Condition, Expression, FnReturn, Forward, FunctionCall, FunctionDeclaration, GetClock, GetSensor, GetSpeed, Leftward, Literal, Loop, Movement, Rightward, RobotML, RobotMlValidationVisitor, Rotate, SetClock, SetSpeed, Statement, Unary, VariableDec, VariableRef } from "./semantics/robot-ml-visitor.js";
